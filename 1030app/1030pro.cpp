...
int auto_report_frameproc(void* pro1030, CANDATAFORM rxmeg)
{
    ...
    {
        csrxcanp->state_info.set_voip_state(
            branch, rxdata.rxinattr.instate2 & 0x01);
    }

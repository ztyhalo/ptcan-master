...
struct can_dev_para_t
{
    Declare_Struct(can_dev_para_t)
        ...
        Define_Enum(1, 6, NO_INSULATE_SWITCH, 1)
        Define_Enum(2, 6, INSULATE_SWITCH, 2)
        Define_Enum(3, 6, CS_DEV, 3)
        Define_Enum(4, 6, LOW_MACH, 4)
        Define_Enum(5, 6, TERMINAL, 5)
        Define_Enum(6, 6, OPERATER, 6)
        Define_Enum(7, 6, IN_DEV, 7)
        Define_Enum(8, 6, OUT_DEV, 8)
        Define_Enum(9, 6, TK100_CSModule, 9)
        Define_Enum(10, 6, TK100_IOModule_Salve, 10)
        Define_Enum(11, 6, TK100_BS_Module, 11)
        Define_Enum(12, 6, TK100_IOModule_IO, 12)
        Define_Enum(13, 6, TK200_CSModule, 13)
        Define_Enum(14, 6, TK200_LOWModule, 14)
        Define_Enum(15, 6, TK200_IOModule, 15)
        Define_Enum(16, 6, TK200_INModule, 16)
